...
Entry = (function() {
  ...
  Entry.prototype.update = function(url) {
    ...
    return this.location = new Location(this.history, this.url);
  };
...
History = (function() {
  ...
  History.prototype._use = function(window) {
    ...
    return Object.defineProperty(this._window, "location", {
      get: function() {
        var _ref;
        return ((_ref = _this._stack[_this._index]) != null ? _ref.location : void 0) || new Location(_this, ABOUT_BLANK);
      },
      set: function(url) {
  ...
  History.prototype.pushState = function(state, title, url) {
    ...
    this._advance();
    return this._stack[this._index] = new Entry(this, url, {
      state: state,
      title: title,
      pop: true
    });
  ...
  History.prototype._assign = function(url) {
    ...
    this._advance();
    this._stack[this._index] = new Entry(this, url);
  ...
  History.prototype.load = function(serialized) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      this._advance();
      _results.push(this._stack[this._index] = new Entry(this, url, state));
    }
    return _results;
  };
...
Location = (function() {
  ...
  function Location(_history, _url) {
  ...
  Location.prototype.__defineGetter__("href", function() {
    var _ref;
    return (_ref = this._url) != null ? _ref.href : void 0;
  });
  ...
  _fn = function(prop) {
    Location.prototype.__defineGetter__(prop, function() {
      var _ref1;
      return ((_ref1 = this._url) != null ? _ref1[prop] : void 0) || "";
    });
    return Location.prototype.__defineSetter__(prop, function(value) {
      var newUrl, _ref1;
      newUrl = URL.parse((_ref1 = this._url) != null ? _ref1.href : void 0);
      newUrl[prop] = value;
